                    ...
                    <section className={step === 1 ? 'space-y-4' : 'hidden'}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="country" name="country" defaultValue="" className={`w-full bg-sky-50/50 border rounded-lg px-4 py-3 text-slate-800 focus:outline-none transition-colors font-medium appearance-none cursor-pointer ${errors.country ? 'border-red-400 focus:border-red-500' : 'border-sky-100 focus:border-sky-400'}`}>
